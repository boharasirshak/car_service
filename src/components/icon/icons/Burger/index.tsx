...
export function Burger(props: IconsProps) {
  return (
    ...
    >
      ...
      />
      <path
        data-type='burger-down'
        d='M4 17.5C4 16.9477 4.44772 16.5 5 16.5H15C15.5523 16.5 16 16.9477 16 17.5C16 18.0523 15.5523 18.5 15 18.5H5C4.44772 18.5 4 18.0523 4 17.5Z'
        fill='white'
      />
    </svg>
  )
